 ...
 */
function harbor_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function harbor_sanitize_css( $css ) {
 ...
 */
function harbor_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function harbor_sanitize_email( $email, $setting ) {
 ...
 */
function harbor_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function harbor_sanitize_html( $html ) {
 ...
 */
function harbor_sanitize_image( $image, $setting ) {
 ...
 */
function harbor_sanitize_nohtml( $nohtml ) {
 ...
 */
function harbor_sanitize_number_absint( $number, $setting ) {
...
function harbor_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function harbor_sanitize_number_range( $number, $setting ) {
 ...
 */
function harbor_sanitize_select( $input, $setting ) {
 ...
 */
function harbor_sanitize_url( $url ) {
