...
class Bean_Portfolio_Taxonomy_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Taxonomy', 'harbor' ), // Name
			array( 'description' => __( 'A cloud of portfolio tags or categories.', 'harbor' ) ) // Args
		);
	}
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'tax' ); ?>"><?php _e( 'Taxonomy:', 'harbor' ); ?></label>
