...
class Bean_Portfolio_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Menu', 'harbor' ), // Name
			array( 'description' => __( 'A custom loop of portfolio posts.', 'harbor' ) ) // Args
		);
	}
		...
		if ( have_posts() ) :
			while ( have_posts() ) :
				...
				?>
					...
					<li>
				<a title="<?php printf( __( 'Permanent Link to %s', 'harbor' ), get_the_title() ); ?>" href="<?php the_permalink(); ?>">
...
?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'harbor' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e( 'Number of Posts: (-1 for Infinite)', 'harbor' ); ?></label>
		<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'postcount' ); ?>" name="<?php echo $this->get_field_name( 'postcount' ); ?>" value="<?php echo $instance['postcount']; ?>" />
		</p>

		<p>
		<label for="<?php echo $this->get_field_id( 'loop' ); ?>"><?php _e( 'Portfolio Loop:', 'harbor' ); ?></label>
